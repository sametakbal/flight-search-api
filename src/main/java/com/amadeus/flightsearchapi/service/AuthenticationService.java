...
public class AuthenticationService {
    ...
    public AuthenticationService(IUserRepository repository, ITokenRepository tokenRepository, PasswordEncoder passwordEncoder,
    ...
    private void saveUserToken(User user, String jwtToken) {
        var token = Token.builder().user(user).content(jwtToken).tokenType(TokenType.BEARER).expired(false).revoked(false).build();
